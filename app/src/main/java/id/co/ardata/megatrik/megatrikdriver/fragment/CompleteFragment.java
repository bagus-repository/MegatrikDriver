...
import id.co.ardata.megatrik.megatrikdriver.adapter.OrderCompleteListAdapter;
import id.co.ardata.megatrik.megatrikdriver.adapter.OrderListAdapter;
...
//                .show();
        ...
        Call<UserOrder> call = apiInterface.getOrderCompleted(sessionManager.getUserId());
...
//                progressHUD.dismiss();
                ...
                if (response.isSuccessful()){
                    List<TechnicianOrdersItem> technicianOrdersItems = response.body().getTechnicianOrders();
                    mAdapter = new OrderCompleteListAdapter(mContext, technicianOrdersItems);
